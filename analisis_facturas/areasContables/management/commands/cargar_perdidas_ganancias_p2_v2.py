...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        estructura = [
            ("12. Ingresos financieros", "INGFIN", "12. Ingresos financieros", [
            ...
            ("13. Gastos financieros", "GASF", "13. Gastos financieros", [
            ...
            ("14. Variación de valor razonable en instrumentos financieros", "VARVAL", "14. Variación de valor razonable en instrumentos financieros", [
                ("a) Valor razonable con cambios en pérdidas y ganancias", "7630,7631,7633", "6630,6631,6633"),
                ("b) Transferencia de ajustes de valor razonable con cambios en el patrimonio neto", "7632", "6632"),
            ]),
            ("15. Diferencias de cambio", "CAMBIO", "15. Diferencias de cambio", [
                ("Diferencias de cambio", "768", "668"),
            ]),
            ("16. Deterioro y resultado por enajenaciones de instrumentos financieros", "ENAJFIN", "16. Deterioro y resultado por enajenaciones de instrumentos financieros", [
                ("a) Deterioros y pérdidas", "796,797,798,799", "696,697,698,699"),
                ("b) Resultados por enajenaciones y otras", "766,773,775", "666,667,673,675"),
            ]),
            ("17. Impuestos sobre beneficios", "IMP", "17. Impuestos sobre beneficios", [
        ...
        self.stdout.write(self.style.SUCCESS("✅ Carga de áreas 12–17 (RESULTADO FINANCIERO) completada correctamente."))
